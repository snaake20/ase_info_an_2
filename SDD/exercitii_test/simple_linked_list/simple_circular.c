...
void main()
{
  ...
  readStudents(&agenda, &noEl, &circularList);
  ...
  printf("Position of Antonescu Robert is %d\n", search(circularList, "Antonescu Robert"));

  // TODO: fix the other fn to work with circular lists

  // deleteAtPos(&list, search(list, "Calinescu Elena"));

  // addToPos(&list, createNode(createStudentInfo("Edi Popescu", 1000, 125)), length(list));

  // addAtTheMiddle(circularList, createNode(createStudentInfo("Edi Popescu", 1000, 125)));
...
// int length_recursive(Node *list)
// {
//   if (!list)
//     return 0;
