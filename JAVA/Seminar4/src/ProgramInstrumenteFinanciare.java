...
public class ProgramInstrumenteFinanciare {
    public static void main(String[] args)
    {
         ...
         * intrumente financiare cu obiecte de tip Intrument si cu obiecte de tip Actiune.
        ...
        Instrument.Operatiune o1 = new Instrument.Operatiune(TipOperatiune.CUMPARARE, LocalDate.of(2000, 10, 22), 20, 30);
        Instrument.Operatiune o2 = new Instrument.Operatiune(TipOperatiune.CUMPARARE, LocalDate.of(2000, 10, 23), 20, 30);
        Instrument.Operatiune o3 = new Instrument.Operatiune(TipOperatiune.CUMPARARE, LocalDate.of(2000, 10, 24), 20, 30);
        ...
        for (var instrument: portofoliu.getPortofoliu().entrySet()){
            val += instrument.getValue().valoare();
            System.out.println(instrument.getKey() + ", data primei tranzactiei: ");
            try {
                LocalDate primaData = Collections.min(instrument.getValue().getOperatiuni(), (o11, o21) -> o11.getData().compareTo(o21.getData())).getData();
